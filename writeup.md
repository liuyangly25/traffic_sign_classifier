...
For the Image 3, the model is very sure that this is a Priority road sign (probability of 1), and the image does contain a Priority road sign. The top five soft max probabilities were
...
This is the Priority road sign visualization. For conv layer 1, all the line were shown clearly. We can see inner is empty, that is the important feature of this sign. And that is why the model is very sure that this is a Priority road sign.

![Conv1 Visual][image14]

For conv layer 2, details can be seen. some details are very important and interesting, e.g.feature map7. I am guessing it means the empty inner part of this Priority road sign.
